<template>
  <div class="space-y-2">
    ...
    <div class="form-control">
      <label class="cursor-pointer label flex justify-start">
        <span class="label-text text-base ml-auto">رنگ عنوان</span>
    ...
    <div class="form-control">
      ...
      <textarea v-model="block.data.title" class="textarea textarea-bordered textarea-sm"></textarea>
    </div>
    <div class="divider pt-5">اضافه کردن ویؤگی جدید</div>
    <div class="form-control">
    ...
    <div class="divider pt-5">لیست ویؤگی ها</div>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return {block, add, remove, title, imageUrl}
  },
})
</script>
