<template>
  <div class="space-y-2">
    ...
    <div class="form-control">
      <label class="cursor-pointer label flex justify-start">
        <span class="label-text text-base ml-auto">پایین هدر</span>
        <input v-model="block.data.hasHeaderBottom" type="checkbox" checked="checked" class="toggle toggle-primary">
      </label>
    </div>
    <div class="divider">کال تو اکشن</div>
    <div class="form-control">
